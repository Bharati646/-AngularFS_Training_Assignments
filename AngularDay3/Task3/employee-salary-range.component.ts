...
@Component({
  selector: 'app-employee-salary-range',
  templateUrl: './employee-salary-range.component.html',
  styleUrls: ['./employee-salary-range.component.css'],
})
export class EmployeeSalaryRangeComponent {
  min: number = 0;
  max: number = 0;
  ...
  filterData_click() {
    this.min = this.filterKey;
    this.max = this.filterValue;
